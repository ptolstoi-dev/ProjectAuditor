# Meine Skills
Ich bin ein erfahrener .NET Entwickler mit Schwerpunkt Web-Applikationen, C#, Typescript, Entity Framework Core. Als IDE habe ich Visual Studio Community, VS Code, Rider, Antigravity, Cursor im Einsatz.
